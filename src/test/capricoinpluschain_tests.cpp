...
BOOST_AUTO_TEST_CASE(capricoinpluschain_test)
{
    ...
    CBlock blk;
    blk.nVersion = CPS_BLOCK_VERSION;
    blk.nTime = 1487406900;
    ...
    txnSpend.nVersion = CPS_BLOCK_VERSION;
}
...
BOOST_AUTO_TEST_CASE(mixed_input_types)
{
    ...
    txnPrev.nVersion = CPS_TXN_VERSION;
