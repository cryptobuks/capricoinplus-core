...
static const uint8_t CPS_BLOCK_VERSION = 0xA0;
static const uint8_t CPS_TXN_VERSION = 0xA0;
static const uint8_t MAX_CPS_TXN_VERSION = 0xBF;
...
{
    return (nVersion & 0xFF) >= CPS_TXN_VERSION;
}
...
public:
    ...
    static const int32_t CURRENT_CPS_VERSION=0xA0;
    ...
    static const int32_t MAX_STANDARD_CPS_VERSION=0xA0;
