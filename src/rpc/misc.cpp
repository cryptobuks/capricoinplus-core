    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            RPCHelpMan{"validateaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The capricoinplus address to validate"},
            ...
            "}\n"
                ...
                RPCExamples{
                    HelpExampleCli("validateaddress", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\"")
            + HelpExampleRpc("validateaddress", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\"")
                },
            }.ToString());
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 4)
        throw std::runtime_error(
            RPCHelpMan{"verifymessage",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The capricoinplus address to use for the signature."},
            ...
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("verifymessage", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\", \"signature\", \"my message\"")
                },
            }.ToString());
    ...
    if (request.fHelp)
        throw std::runtime_error(
            RPCHelpMan{"echo|echojson ...",
                ...
                "capricoinplus-cli and the GUI. There is no server-side difference.",
                {},
                RPCResults{},
                RPCExamples{""},
            }.ToString()
