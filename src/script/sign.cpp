...
const DummySignatureCheckerCapricoinPlus DUMMY_CHECKER_CPS;
...
public:
    ...
    const BaseSignatureChecker& Checker() const override { return DUMMY_CHECKER_CPS; }
    bool IsCapricoinPlusVersion() const override { return true; }
};
...
const BaseSignatureCreator& DUMMY_SIGNATURE_CREATOR_CPS = DummySignatureCreatorCapricoinPlus();
