...
void EnsureWalletIsUnlocked(CWallet * const pwallet)
{
    ...
    if (IsCapricoinPlusWallet(pwallet)
        && GetCapricoinPlusWallet(pwallet)->fUnlockForStakingOnly)
...
static UniValue getnewaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 5)
        throw std::runtime_error(
            RPCHelpMan{"getnewaddress",
                ...
                RPCResult{
            "\"address\"    (string) The new capricoinplus address\n"
                },
                RPCExamples{
    ...
    size_t type_ofs = fCapricoinPlusMode ? 4 : 1;
    ...
    if (IsCapricoinPlusWallet(pwallet)) {
        ...
        CPubKey newKey;
        CHDWallet *phdw = GetCapricoinPlusWallet(pwallet);
        {
            LOCK(cs_main);
            {
                LOCK(phdw->cs_wallet);
    ...
    if (request.fHelp || request.params.size() > 1)
        throw std::runtime_error(
            RPCHelpMan{"getrawchangeaddress",
                "\nReturns a new Capricoin+ address, for receiving change.\n"
    ...
    if (request.fHelp || request.params.size() != 2)
        throw std::runtime_error(
            RPCHelpMan{"setlabel",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED_NAMED_ARG, "The capricoinplus address to be associated with a label."},
                    {"label", RPCArg::Type::STR, RPCArg::Optional::OMITTED_NAMED_ARG, "The label to assign to the address."},
                },
                RPCResults{},
                RPCExamples{
                    HelpExampleCli("setlabel", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\" \"tabby\"")
            + HelpExampleRpc("setlabel", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\", \"tabby\"")
                },
            }.ToString());
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 9)
        throw std::runtime_error(
            RPCHelpMan{"sendtoaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The capricoinplus address to send to."},
            ...
            "                             The recipient will receive less capricoinplus than you enter in the amount field."},
            ...
            "\"txid\"                  (string) The transaction id.\n"
                ...
                RPCExamples{
                    HelpExampleCli("sendtoaddress", "\"8aR8XCSj4XVDyMXjE6tHQxaMuABcwTdzPz\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"8aR8XCSj4XVDyMXjE6tHQxaMuABcwTdzPz\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"8aR8XCSj4XVDyMXjE6tHQxaMuABcwTdzPz\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"8aR8XCSj4XVDyMXjE6tHQxaMuABcwTdzPz\", 0.1, \"donation\", \"seans outpost\"")
                },
            }.ToString());
...
static UniValue listaddressgroupings(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 0)
        throw std::runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"address\",            (string) The capricoinplus address\n"
        ...
        throw std::runtime_error(
            RPCHelpMan{"signmessage",
                "\nSign a message with the private key of an address" +
                    HelpRequiringPassphrase(pwallet) + "\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The capricoinplus address to use for the private key."},
            ...
            + HelpExampleCli("signmessage", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\" \"signature\" \"my message\"") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("signmessage", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\", \"my message\"")
                },
            }.ToString());
...
static UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            RPCHelpMan{"getreceivedbyaddress",
                ...
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The capricoinplus address for transactions."},
            ...
            + HelpExampleCli("getreceivedbyaddress", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\" 0") +
            "\nThe amount with at least 6 confirmation\n"
            + HelpExampleCli("getreceivedbyaddress", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\" 6") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\", 6")
                },
            }.ToString());
    ...
    for (const std::pair<const uint256, CWalletTx>& pairWtx : pwallet->mapWallet) {
        ...
        if ((!fCapricoinPlusWallet && wtx.IsCoinBase()) || !CheckFinalTx(*wtx.tx))
            continue;
...
static UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw std::runtime_error(
            RPCHelpMan{"sendmany",
                    ...
                    HelpRequiringPassphrase(pwallet) + "\n",
                {
                    ...
                    {"amounts", RPCArg::Type::OBJ, RPCArg::Optional::NO, "A json object with addresses and amounts",
                        {
                            {"address", RPCArg::Type::AMOUNT, RPCArg::Optional::NO, "The capricoinplus address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value"},
                        },
                    },
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\\\":0.01,\\\"8SU3nMz2VZSGn94MsWhpBGpDb3suSRPfeT\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\\\":0.01,\\\"8SU3nMz2VZSGn94MsWhpBGpDb3suSRPfeT\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\\\":0.01,\\\"8SU3nMz2VZSGn94MsWhpBGpDb3suSRPfeT\\\":0.02}\" 1 \"\" \"[\\\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\\\",\\\"8SU3nMz2VZSGn94MsWhpBGpDb3suSRPfeT\\\"]\"") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("sendmany", "\"\", {\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\":0.01,\"8SU3nMz2VZSGn94MsWhpBGpDb3suSRPfeT\":0.02}, 6, \"testing\"")
                },
            }.ToString());
...
static UniValue addmultisigaddress(const JSONRPCRequest& request)
{
        ...
        std::string msg =
            RPCHelpMan{"addmultisigaddress",
                ...
                "If 'label' is specified, assign address to that label.\n",
                {
                    ...
                    {"keys", RPCArg::Type::ARR, RPCArg::Optional::NO, "A json array of capricoinplus addresses or hex-encoded public keys",
                        {
                            {"key", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "capricoinplus address or hex-encoded public key"},
                        },
                        },
            ...
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"8aR8XCSj4XVDyMXjE6tHQxaMuABcwTdzPz\\\",\\\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\\\"]\"") +
            "\nAs a JSON-RPC call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"8aR8XCSj4XVDyMXjE6tHQxaMuABcwTdzPz\\\",\\\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\\\"]\"")
                },
            }.ToString();
    ...
    OutputType output_type = pwallet->m_default_address_type;
    size_t type_ofs = fCapricoinPlusMode ? 5 : 3;
    if (!request.params[type_ofs].isNull()) {
        if (!ParseOutputType(request.params[type_ofs].get_str(), output_type)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, strprintf("Unknown address type '%s'", request.params[type_ofs].get_str()));
        }
    ...
    bool fbech32 = fCapricoinPlusMode && request.params.size() > 3 ? request.params[3].get_bool() : false;
    bool f256Hash = fCapricoinPlusMode && request.params.size() > 4 ? request.params[4].get_bool() : false;
    ...
    if (listReceived.size() > 0 && wtx.GetDepthInMainChain(locked_chain) >= nMinDepth) {
        for (const COutputEntry &r : listReceived) {
            ...
            if (fCapricoinPlusWallet
                ...
                if (GetCapricoinPlusWallet(pwallet)->GetStealthLinked(idK, sx)) {
            ...
            if (wtx.IsCoinBase()) {
                ...
                if (wtx.IsImmatureCoinBase(locked_chain)) {
                    ...
                    entry.pushKV("category", (fCapricoinPlusMode ? "coinbase" : "generate"));
                }
            } else {
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw std::runtime_error(
            ...
            "[\n"
            "  {\n"
            "    \"address\":\"address\",    (string) The capricoinplus address of the transaction.\n"
...
UniValue gettransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "  \"details\" : [\n"
            "    {\n"
            "      \"address\" : \"address\",          (string) The capricoinplus address involved in the transaction\n"
            "      \"category\" :                      (string) The transaction category.\n"
            "                   \"send\"                  Transactions sent.\n"
            "                   \"receive\"               Non-coinbase transactions received.\n"
            "                   \"generate\"              Coinbase transactions received with more than 100 confirmations.\n"
...
static UniValue abandontransaction(const JSONRPCRequest& request)
{
    ...
    if (!pwallet->mapWallet.count(hash)) {
        if (!IsCapricoinPlusWallet(pwallet) || !GetCapricoinPlusWallet(pwallet)->HaveTransaction(hash)) {
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, "Invalid or non-wallet transaction id");
        }
    }
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3) {
        throw std::runtime_error(
            RPCHelpMan{"walletpassphrase",
                ...
                "This is needed prior to performing transactions related to private keys such as sending capricoinplus\n"
            "\nNote:\n"
...
static UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 0) {
        throw std::runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"8aR8XCSj4XVDyMXjE6tHQxaMuABcwTdzPz\" 1.0") +
...
static UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1) {
        throw std::runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending capricoinplus\n"
...
static UniValue getwalletinfo(const JSONRPCRequest& request)
{
    ...
    if (fCapricoinPlusWallet) {
        ...
        obj.pushKV("total_balance",         ValueFromAmount(
            bal.nStandard + bal.nStandardUnconf + bal.nStandardStaked + bal.nStandardImmature
            + bal.nBlind + bal.nBlindUnconf
            + bal.nAnon + bal.nAnonUnconf + bal.nAnonImmature));

        obj.pushKV("balance",               ValueFromAmount(bal.nStandard));

        obj.pushKV("blind_balance",         ValueFromAmount(bal.nBlind));
        obj.pushKV("anon_balance",          ValueFromAmount(bal.nAnon));
        obj.pushKV("staked_balance",        ValueFromAmount(bal.nStandardStaked));

        obj.pushKV("unconfirmed_balance",   ValueFromAmount(bal.nStandardUnconf));
        obj.pushKV("unconfirmed_blind",     ValueFromAmount(bal.nBlindUnconf));
        obj.pushKV("unconfirmed_anon",      ValueFromAmount(bal.nAnonUnconf));
        obj.pushKV("immature_balance",      ValueFromAmount(bal.nStandardImmature));
        obj.pushKV("immature_anon_balance", ValueFromAmount(bal.nAnonImmature));

        if (bal.nStandardWatchOnly > 0 || bal.nStandardWatchOnlyUnconf > 0 || bal.nStandardWatchOnlyStaked > 0) {
            obj.pushKV("watchonly_balance",                 ValueFromAmount(bal.nStandardWatchOnly));
            obj.pushKV("watchonly_staked_balance",          ValueFromAmount(bal.nStandardWatchOnlyStaked));
            obj.pushKV("watchonly_unconfirmed_balance",     ValueFromAmount(bal.nStandardWatchOnlyUnconf));
            obj.pushKV("watchonly_total_balance",
                ValueFromAmount(bal.nStandardWatchOnly + bal.nStandardWatchOnlyStaked + bal.nStandardWatchOnlyUnconf));
        }
    } else {
    ...
    int nTxCount = (int)pwallet->mapWallet.size() + (fCapricoinPlusWallet ? (int)((CHDWallet*)pwallet)->mapRecords.size() : 0);
    obj.pushKV("txcount",       (int)nTxCount);

    CKeyID seed_id;
    if (IsCapricoinPlusWallet(pwallet)) {
        CHDWallet *pwhd = GetCapricoinPlusWallet(pwallet);
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            RPCHelpMan{"loadwallet",
                ...
                "\nNote that all wallet command-line options used when starting capricoinplusd will be"
...
static UniValue listunspent(const JSONRPCRequest& request)
{
        ...
        throw std::runtime_error(
            RPCHelpMan{"listunspent",
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, /* default */ "empty array", "A json array of capricoinplus addresses to filter",
                        {
                            {"address", RPCArg::Type::STR, RPCArg::Optional::OMITTED, "capricoinplus address"},
                        },
                    },
            ...
            "    \"coldstaking_address\"  : \"address\" (string) the capricoinplus address this output must stake on\n"
    ...
    if (!request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!IsValidDestination(dest)) {
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, std::string("Invalid Capricoin+ address: ") + input.get_str());
            }
...
void FundTransaction(CWallet* const pwallet, CMutableTransaction& tx, CAmount& fee_out, int& change_position, UniValue options)
{
    ...
    size_t nOutputs = IsCapricoinPlusWallet(pwallet) ? tx.vpout.size() : tx.vout.size();
    if (nOutputs == 0)
    ...
    const RPCHelpMan help{"fundrawtransaction",
                ...
                "Only pay-to-pubkey, multisig, and P2SH versions thereof are currently supported for watch-only\n",
                {
                    ...
                    {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG, "for backward compatibility: passing in a true instead of an object will result in {\"includeWatching\":true}",
                        {
                            {"changeAddress", RPCArg::Type::STR, /* default */ "pool address", "The capricoinplus address to receive the change"},
...
UniValue getaddressinfo(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1) {
        throw std::runtime_error(
            ...
            "\nReturn information about the given capricoinplus address. Some information requires the address\n"
            "to be in the wallet.\n",
                {
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The capricoinplus address to get the information of."},
                },
                RPCResult{
            "{\n"
            "  \"address\" : \"address\",        (string) The capricoinplus address validated\n"
            ...
            "}\n"
                ...
                RPCExamples{
                    HelpExampleCli("getaddressinfo", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\"")
            + HelpExampleRpc("getaddressinfo", "\"8Pv616QVVKW4M5RFQDmdNsJ1uniYyDmnJd\"")
                },
            }.ToString());
    }
...
UniValue sethdseed(const JSONRPCRequest& request)
{
    ...
    if (IsCapricoinPlusWallet(pwallet))
        throw JSONRPCError(RPC_WALLET_ERROR, "Not necessary in Capricoin+ mode.");
        ...
        throw std::runtime_error(
            RPCHelpMan{"walletcreatefundedpsbt",
                ...
                "Implements the Creator and Updater roles.\n",
                {
                    ...
                    {"options", RPCArg::Type::OBJ, RPCArg::Optional::OMITTED_NAMED_ARG, "",
                        {
                            {"changeAddress", RPCArg::Type::STR_HEX, /* default */ "pool address", "The capricoinplus address to receive the change"},
                            {"changePosition", RPCArg::Type::NUM, /* default */ "random", "The index of the change output"},
                            {"change_type", RPCArg::Type::STR, /* default */ "set by -changetype", "The output type to use. Only valid if changeAddress is not specified. Options are \"legacy\", \"p2sh-segwit\", and \"bech32\"."},
                            {"includeWatching", RPCArg::Type::BOOL, /* default */ "false", "Also select inputs which are watch only"},
                            {"lockUnspents", RPCArg::Type::BOOL, /* default */ "false", "Lock selected unspent outputs"},
