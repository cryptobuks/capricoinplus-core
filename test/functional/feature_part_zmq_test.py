...
class ZMQTest(CapricoinPlusTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that capricoinplus has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("capricoinplusd has not been built with zmq enabled.")
