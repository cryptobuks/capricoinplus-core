...
class USBDeviceTest(CapricoinPlusTestFramework):
    ...
    def run_test(self):
        ...
        # Check that capricoinplus has been built with USB device enabled
        ...
        if not config["components"].getboolean("ENABLE_USBDEVICE"):
            raise SkipTest("capricoinplusd has not been built with usb device enabled.")
